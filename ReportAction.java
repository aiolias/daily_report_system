...
public class ReportAction extends ActionBase {
    ...
    private static final int GoodCount = 0;
    ...
    public void goodCount() throws ServletException, IOException {
        ...
        //いいね数を1加算する
        int goodCount = rv.getGoodCount();
        rv.setGoodCount(goodCount + 1);

        //日報データを更新する
        service.update(rv);

        //セッションに｢この日報にいいねする｣を押下した時のフラッシュメッセージを設定
        putSessionScope(AttributeConst.FLUSH, MessageConst.I_GOODCOUNT.getMessage());
