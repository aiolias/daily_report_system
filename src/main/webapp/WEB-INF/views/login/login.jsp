...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <form method="POST" action="<c:url value='/?action=${action}&command=${command}' />">
            <label for="${AttrivuteConst.EMP_CODE.getValue()}">社員番号</label><br />
            <input type="text" name="${AttrivuteConst.EMP_CODE.getValue()}" id="${AttrivuteConst.EMP_CODE.getValue()}" value="${code}" />
            <br /><br />
            ...
            <input type="hidden" name="${AttrivuteConst.TOKEN.getValue()}" value="${_token}" />
